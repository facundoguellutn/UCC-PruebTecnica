  ...
  return (
    <div className='w-screen h-screen flex flex-col items-center justify-center'>
      ...
      <form onSubmit={handleSubmit} className='flex items-center justify-center flex-col py-4 px-4 rounded-[20px] border-[1px] border-[#BCBCBE] w-[250px] sm:w-[370px]'>
        ...
        <InputText value={values.password} placeholder='Contraseña' name='password' required={true} type='password' onChange={(e) => handleChange(e)} className='w-full' />
        <button className='mt-6 w-full bg-blue500 text-white py-2 rounded-[10px] text-[24px]'>Ingresar</button>
