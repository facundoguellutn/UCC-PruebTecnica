    ...
    return (
        ...
        <div className='flex flex-col w-full pt-2'>
            <form onSubmit={handleSubmit}>
                <InputText className='w-full' required={true} placeholder="Profesion" value={values.profesion} style={{ marginBottom: "20px" }} onChange={(e) => { handleChange(e) }} name='profesion' />
                <InputTextarea className='w-full' required={true} placeholder="Descripcion" value={values.descripcion} style={{ marginBottom: "20px" }} onChange={(e) => { handleChange(e) }} name='descripcion' />
                <div className='flex flex-row justify-center items-center'>
